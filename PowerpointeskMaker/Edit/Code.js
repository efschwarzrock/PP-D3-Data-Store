...
//updates the window by deleting the old window and remaking it
function update(){
...
//creates the start polygon and stop polygon button
...
//creates the delete polygon button
...
//renders the button to bring up aditional UI
...
//creates the color, opacity, and window buttons
...
//updates the text as it is typed
...
//selects the polygon when it is clicked
...
//send you to the linked window when it is double clicked
...
//manualy send you to the given window
function goToWindow(){
